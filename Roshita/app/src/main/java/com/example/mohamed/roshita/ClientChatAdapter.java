...
public class ClientChatAdapter extends RecyclerView.Adapter<ClientChatAdapter.MyHolder> {
    private Context context;
    private ArrayList<UserModel> users;
    private ArrayList<String> sellersIds;
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra("receiverId" ,sellersIds.get(position) );
    ...
    public ClientChatAdapter(Context context ,ArrayList<UserModel> users ,ArrayList<String> sellersIds ,RecyclerView recyclerView){
